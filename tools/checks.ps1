...
foreach($project in @('Configuration','Reliability','Connector','ViewerLifecycle','Automation','AutomationHealth','Tapo','LanAccess','RestartSchedule','Maintenance','Weather','LayoutVisibility','Ui')) {
...
foreach($check in @('admin-security','connector-http','tapo-http','layout-lan-http','wall-layout-presets','wall-proportions','shape-editor','dashboard-ux','viewer-controls','application-restart','automation-health','related-choices','preview-refresh','lan-firewall','branding','privacy')) {
