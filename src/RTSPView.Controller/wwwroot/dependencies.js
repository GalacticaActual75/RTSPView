const dependencyUi = (()=>{
  ...
  async function refresh(){
    ...
    try{
      ...
      const active=['starting','enabling','downloading','installing'].includes(state.state);
