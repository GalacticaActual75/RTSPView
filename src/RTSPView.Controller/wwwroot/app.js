...
combineViewerControls();adminLayout.init();const networkPanel=createNetworkPanel();snapshotUi.init();restartScheduleUi.init();updateNotifications.init();temperatureUi.init();systemTabs.init();
