...
prepareDisplayForm();adminLayout.init();const networkPanel=createNetworkPanel();snapshotUi.init();restartScheduleUi.init();updateNotifications.init();temperatureUi.init();dependencyUi.init();automationUi.init();systemTabs.init();
