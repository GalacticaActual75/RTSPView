...
function cameraCard(camera,overlay=null,overlayDefinition=null){
 ...
 if(overlayMode)overlaySourceUi.bind(form,overlay,cameraInventory); adminLayout.card(form,overlayMode);if(overlayMode)automationUi.decorateOverlay(form);return form
}
