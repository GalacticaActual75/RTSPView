...
const adminUi = (() => {
  ...
  function page(id) { document.title = 'RTSPView · '+({overview:'Monitor',cameras:'Streams',layouts:'Layouts',overlays:'Stream Overlays',automation:'Automation',system:'Settings'})[id]; }
