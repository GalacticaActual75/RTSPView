const q=s=>document.querySelector(s),login=q('#login'),app=q('#app'),grid=q('#cameras'),doorbellGrid=q('#doorbell'),garageGrid=q('#garage');const mainCameraIds=[1,2,3,4,5,6,7,8,9,26,27,28,29,30,31,32];let csrfToken='';
