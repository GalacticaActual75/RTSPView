...
public sealed record MaintenanceRequest(string Command, Guid? OperationId = null, string? Channel = null, string? Version = null);
public sealed record MaintenanceStatus
{
    public bool Available { get; init; }
    public bool SupportsAppUpdates { get; init; }
