...
echo Stopping SpotMonitor controller and viewer...
...
if errorlevel 1 (
  echo Could not stop SpotMonitor.
  pause
  exit /b 1
)
echo SpotMonitor will remain closed until manually started or the next Windows logon.
pause
endlocal
