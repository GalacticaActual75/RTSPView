...
Settings → Plugins controls Weather, Aircraft, yt-dlp, ONVIF, Streamlink, Picture in picture, and Automations for this host. Apply changes persists all seven switches. Existing installations retain enabled behavior until a switch is turned off.
