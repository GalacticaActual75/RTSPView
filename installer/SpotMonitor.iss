...
Filename: "{sys}\netsh.exe"; Parameters: "advfirewall firewall add rule name=""SpotMonitor Web Admin - Private LAN"" dir=in action=allow protocol=TCP localport=5080 profile=private enable=yes"; Flags: runhidden waituntilterminated
Filename: "{sys}\netsh.exe"; Parameters: "advfirewall firewall add rule name=""SpotMonitor Web Admin - Block Public"" dir=in action=block protocol=TCP localport=5080 profile=public enable=yes"; Flags: runhidden waituntilterminated
